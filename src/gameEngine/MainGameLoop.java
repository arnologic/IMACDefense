...
public class MainGameLoop extends Thread{
    ...
    public MainGameLoop() {
    	...
    	// Canvas
    	/*
    	 * On attache un canvas � la fen�tre frame
    	 */
    ...
    // G�re la fermeture de la fen�tre avec un thread, non param�tr� par d�faut dans swing
    ...
    // Pour chaque rafra�chissement d'�cran
    ...
    public void run() {
    	...
    	main: while (isRunning) {
    		...
    		updateGame(); // Mise � jour des donn�es logiques
    		updateMove();
    		if(frameCount == 0){
    			if(frameLag == true){
    				updateLifeNano();
    		...
    		do {
    			...
    			renderGame(bg); // On dessine les �l�ments dans le canvas
    		} while (!updateScreen());
